...
\draw[draw=black,thick] (1,3) rectangle ++(1,1);
...
\draw[draw=none,fill=gray!10] (0,0) -- (3.25,0) .. controls (3.5,3.5) .. (0,3.25) -- (0,0);
...
%3rd
\draw[draw=black,thin] (0,2.5) rectangle ++(.5,-.5);
%2nd
\draw[draw=black,thin] (2.5,0) rectangle ++(-.5,.5);
%1st 
\draw[draw=black,thin] (2.5,2.5) rectangle ++(-.5,-.5);
